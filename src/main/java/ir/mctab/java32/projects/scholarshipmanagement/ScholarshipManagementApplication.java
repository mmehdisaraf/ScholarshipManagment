    ...
    public static void main(String[] args) {
        ...
        while (!command.equals("exit")) {
            ...
            if (command.equals("dashboard")) {
                ...
                command = scanner.nextLine();
                if (command.equals("Student Dashboard")) {
                ...
                if (command.equals("Manager Dashboard")) {
                    DashboardManagerUseCase dashboardManagerUseCase =
                            new DashboardManagerUseCaseImpl();
                    List<Scholarship> scholarship = dashboardManagerUseCase
                            .listScholarships();
                    for (int i = 0; i < scholarship.size(); i++) {
                        System.out.println(scholarship.get(i));
                    }
                }
                if (command.equals("Supervisor Dashboard")) {
                    DashboardSupervisorUseCase dashboardSupervisorUseCase =
                            new DashboardSupervisorUseCaseImpl();
                    List<Scholarship> scholarship = dashboardSupervisorUseCase
                            .listScholarships();
                    for (int i = 0; i < scholarship.size(); i++) {
                        System.out.println(scholarship.get(i));
                    }
